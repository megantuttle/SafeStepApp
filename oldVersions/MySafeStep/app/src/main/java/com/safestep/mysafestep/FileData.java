...
public class FileData extends Activity {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String file_name = "/home/megan/MySafeStep/app/src/main/java/com/safestep/mysafestep/data.txt";
...
/*    private View chart;
    ...
    private void createChart() {
        ...
        *//***
        ...
        //drawing bar chart
        chart = ChartFactory.getBarChartView(FileData.this, dataset, renderer, Type.DEFAULT);
